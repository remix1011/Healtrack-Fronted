...
public class CaloriesReportActivity extends AppCompatActivity {
    public static int REQUEST_CODE = 158;
    ...
    private int idUser;
    private List<CaloriesHistory> histories;
    ...
    private void getHistory() {
        ...
        AndroidNetworking.get(HealthTrackApi.CALORIES_HISTORY_BY_USER_IN_DATES(idUser, dayStart, dayEnd))
                ...
                .getAsJSONArray(new JSONArrayRequestListener() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        histories.clear();
                        histories.addAll(CaloriesHistory.from(response));
                        if (histories.isEmpty())
                            histories.add(new CaloriesHistory(0, 1, "2022-09-20T09:30:45.163", 0, false));
    ...
    private void cargarGrafico(List<CaloriesHistory> histories) {
        List<String> labels = getXAxisLabels(histories);
        ArrayList<BarEntry> barEntries = new ArrayList<>();
        barEntries = new ArrayList<>();
        for (int i = 0; i < histories.size(); i++) {
            CaloriesHistory history = histories.get(i);
            barEntries.add(new BarEntry(i, (float) history.getCalories()));
        }

        BarDataSet barDataSet = new BarDataSet(barEntries, "Calorías quemadas");
        ...
        barData.setValueFormatter(new ValueFormatter() {
            ...
            public String getBarLabel(BarEntry barEntry) {
                return String.valueOf((int) barEntry.getY()) + " cal";
            }
        });
    ...
    private List<String> getXAxisLabels(List<CaloriesHistory> histories) {
        List<String> labels = new ArrayList<>();
        for (CaloriesHistory history : histories) {
