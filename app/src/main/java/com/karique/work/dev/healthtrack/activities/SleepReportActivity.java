...
public class SleepReportActivity extends AppCompatActivity {
    public static int REQUEST_CODE = 160;
    ...
    private int idUser;
    private List<SleepHistory> histories;
    ...
    private void getHistory() {
        ...
        AndroidNetworking.get(HealthTrackApi.SLEEP_HISTORY_BY_USER_IN_DATES(idUser, dayStart, dayEnd))
                ...
                .getAsJSONArray(new JSONArrayRequestListener() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        histories.clear();
                        histories.addAll(SleepHistory.from(response));
                        if (histories.isEmpty())
                            histories.add(new SleepHistory(0, 1, "2022-09-20T09:30:45.163", "2022-09-20T09:30:45.163", "2022-09-20T09:30:45.163", 1, false));
    ...
    private void cargarGrafico(List<SleepHistory> histories) {
        List<String> labels = getXAxisLabels(histories);
        ArrayList<BarEntry> barEntries = new ArrayList<>();
        barEntries = new ArrayList<>();
        for (int i = 0; i < histories.size(); i++) {
            SleepHistory history = histories.get(i);
            Date startDate = FuncionesFecha.getDateWithHourFromString(history.getStartDateTime());
            Date endDate = FuncionesFecha.getDateWithHourFromString(history.getEndDateTime());
        ...
        BarDataSet barDataSet = new BarDataSet(barEntries, "Horas de sueño");
        ...
        barData.setValueFormatter(new ValueFormatter() {
            ...
            public String getBarLabel(BarEntry barEntry) {
                return String.valueOf((int) barEntry.getY()) + " Horas";
            }
        });
    ...
    private List<String> getXAxisLabels(List<SleepHistory> histories) {
        List<String> labels = new ArrayList<>();
        for (SleepHistory history : histories) {
