...
public class WeightReportActivity extends AppCompatActivity {
    public static int REQUEST_CODE = 161;
    ...
    private void getHistory() {
        ...
        AndroidNetworking.get(HealthTrackApi.WEIGHT_HISTORY_BY_USER_IN_DATES(idUser, dayStart, dayEnd))
                ...
                .getAsJSONArray(new JSONArrayRequestListener() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        histories.clear();
                        histories.addAll(WeightHistory.from(response));
                        if (histories.isEmpty())
                            histories.add(new WeightHistory(0, 1, "2022-09-20T09:30:45.163", 0, false));
    ...
    private void cargarGrafico(List<WeightHistory> histories) {
        List<String> labels = getXAxisLabels(histories);
        ArrayList<BarEntry> barEntries = new ArrayList<>();
        barEntries = new ArrayList<>();
        for (int i = 0; i < histories.size(); i++) {
            WeightHistory history = histories.get(i);
            barEntries.add(new BarEntry(i, (float) history.getWeight()));
        }

        BarDataSet barDataSet = new BarDataSet(barEntries, "Peso");
        ...
        barData.setValueFormatter(new ValueFormatter() {
            ...
            public String getBarLabel(BarEntry barEntry) {
                return String.valueOf((int) barEntry.getY()) + " kg";
            }
        });
    ...
    private List<String> getXAxisLabels(List<WeightHistory> histories) {
        List<String> labels = new ArrayList<>();
        for (WeightHistory history : histories) {
