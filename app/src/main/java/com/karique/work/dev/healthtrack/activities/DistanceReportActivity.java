...
public class DistanceReportActivity extends AppCompatActivity {
    public static int REQUEST_CODE = 157;
    ...
    private int idUser;
    private List<DistanceHistory> histories;
    ...
    private void getHistory() {
        ...
        AndroidNetworking.get(HealthTrackApi.DISTANCE_HISTORY_BY_USER_IN_DATES(idUser, dayStart, dayEnd))
                ...
                .getAsJSONArray(new JSONArrayRequestListener() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        histories.clear();
                        histories.addAll(DistanceHistory.from(response));
                        if (histories.isEmpty())
                            histories.add(new DistanceHistory(0, 1, "2022-09-20T09:30:45.163", 0, false));
    ...
    private void cargarGrafico(List<DistanceHistory> histories) {
        List<String> labels = getXAxisLabels(histories);
        ArrayList<BarEntry> barEntries = new ArrayList<>();
        barEntries = new ArrayList<>();
        for (int i = 0; i < histories.size(); i++) {
            DistanceHistory history = histories.get(i);
            barEntries.add(new BarEntry(i, (float) history.getDistance()));
        }

        BarDataSet barDataSet = new BarDataSet(barEntries, "Distancias recorridas");
        ...
        barData.setValueFormatter(new ValueFormatter() {
            ...
            public String getBarLabel(BarEntry barEntry) {
                return String.valueOf((int) barEntry.getY()) + " m";
            }
        });
    ...
    private List<String> getXAxisLabels(List<DistanceHistory> histories) {
        List<String> labels = new ArrayList<>();
        for (DistanceHistory history : histories) {
